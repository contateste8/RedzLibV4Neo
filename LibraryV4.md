...
## Library loadstring
```lua
local Library = loadstring(game:HttpGet("https://github.com/contateste8/RedzLibV4Neo/raw/refs/heads/main/Source.lua"))()
```

library functions
```lua
Library:SetTheme("Theme Name") -- https://github.com/contateste8/RedzLibV4Neo/raw/refs/heads/main/Themes.lua
